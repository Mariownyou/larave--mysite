    ...
    <div
        ...
        <div class="common">
            <div class="content">
                ...
                <form id="form-note" action="{{ route('tags.store') }}" enctype="multipart/form-data" method="post"
                    ...
                    <div class="form" id="e2-note-form-wrapper">
                        ...
                        <div class="form-control">
                            ...
                            @include('includes.editor.componetns.checkbox', ['name' => 'favorite', 'value' => ' Добавить в избранное'])
                            @include('includes.editor.componetns.checkbox', ['name' => 'navbar', 'value' => ' Показывать в навигации'])
                        </div>
